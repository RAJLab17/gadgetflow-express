...
export const STATIC_URLS: SitemapEntry[] = [
    ...
    images: [
      {
        ...
        title: "RAJ - Swiss Premium Wireless Charging",
        caption: "RAJ Logo - Power. Always There.",
      },
      {
        loc: `${SITE_URL}/raj-nexus-product.png`,
        title: "RAJ NEXUS 3-in-1 Wireless Charger",
        caption: "RAJ NEXUS Premium 3-in-1 Qi2.2 Wireless Charger",
      },
      {
  ...
  { path: "/product/foldable-charger", lastmod: TODAY, changefreq: "weekly", priority: 0.8 },
  { path: "/product/stand-charger-3in1", lastmod: TODAY, changefreq: "weekly", priority: 0.8 },
  { path: "/product/magsafe-powerbank", lastmod: TODAY, changefreq: "weekly", priority: 0.8 },
  { path: "/product/powerbank-ultra-20k", lastmod: TODAY, changefreq: "weekly", priority: 0.8 },
  { path: "/product/car-charger-4in1", lastmod: TODAY, changefreq: "weekly", priority: 0.8 },
  { path: "/product/gan-supercharger-100w", lastmod: TODAY, changefreq: "weekly", priority: 0.8 },
  { path: "/product/usb-charger-35w", lastmod: TODAY, changefreq: "weekly", priority: 0.8 },
  { path: "/product/magnetic-cable", lastmod: TODAY, changefreq: "weekly", priority: 0.8 },
