...
const translations: Translations = {
 ...
 "faq.contact.sub": { de: "Antwort meist innerhalb von 24 Stunden · Direkt vom Gründer", fr: "Réponse en général sous 24 heures · Directement du fondateur", it: "Risposta di solito entro 24 ore · Direttamente dal fondatore" },
  ...
  "brand.hero.sub": {
    de: "Das Gewöhnliche überzeugt durch Lautstärke. Das Aussergewöhnliche durch Stille.\nPrestige braucht keine Stimme. Es spricht durch die Hand, die es hält.",
    fr: "L'ordinaire convainc par le bruit. L'extraordinaire par le silence.\nLe prestige n'a pas besoin de voix. Il parle par la main qui le tient.",
    it: "L'ordinario convince con il rumore. Lo straordinario con il silenzio.\nIl prestigio non ha bisogno di voce. Parla attraverso la mano che lo tiene.",
    en: "The ordinary convinces through volume. The extraordinary through silence.\nPrestige needs no voice. It speaks through the hand that holds it.",
  },
  ...
  "brand.story.link.about.cta":     { de: "Mehr erfahren", fr: "En savoir plus", it: "Scopri di più", en: "Discover our story" },
