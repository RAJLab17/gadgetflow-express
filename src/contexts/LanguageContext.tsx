...
const translations: Translations = {
 ...
 "faq.contact.sub": { de: "Antwort meist innerhalb von 24 Stunden · Direkt vom Gründer", fr: "Réponse en général sous 24 heures · Directement du fondateur", it: "Risposta di solito entro 24 ore · Direttamente dal fondatore" },
  ...
  "brand.hero.sub": {
    de: "Wir bauen für die Menschen, die das Bleibende dem Lauten vorziehen.\nFür Hände, die Qualität spüren, bevor das Auge sie sieht.",
    fr: "Nous créons pour celles et ceux qui préfèrent le durable au bruyant.\nPour des mains qui sentent la qualité avant que l'œil ne la voie.",
    it: "Creiamo per chi preferisce ciò che resta a ciò che grida.\nPer mani che sentono la qualità prima che l'occhio la veda.",
    en: "We build for those who choose the lasting over the loud.\nFor hands that feel quality before the eye can see it.",
  },
