...
const translations: Translations = {
  ...
  "launch.provocation.prefix": { de: "Endlich", fr: "Enfin", it: "Finalmente" },
  "launch.provocation.highlight": { de: "kein Kabelchaos", fr: "fini le chaos de câbles", it: "basta col caos dei cavi" },
