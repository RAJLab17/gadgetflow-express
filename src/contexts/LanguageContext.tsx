...
const translations: Translations = {
  ...
  "hero.sub": { de: "Trag dich ein und sichere dir CHF 30 Rabatt + ein gratis USB-C Kabel (Wert CHF 19) — exklusiv für die ersten 100.", fr: "Inscris-toi et obtiens CHF 30 de remise + un câble USB-C gratuit (valeur CHF 19) — exclusif pour les 100 premiers.", it: "Iscriviti e ottieni CHF 30 di sconto + un cavo USB-C gratis (valore CHF 19) — esclusivo per i primi 100." },
  ...
  "hero.benefit.cable": { de: "Gratis USB-C Kabel", fr: "Câble USB-C gratuit", it: "Cavo USB-C gratis" },
