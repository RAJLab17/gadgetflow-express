...
import nexusHero from "@/assets/nexus-hero-floating.png";
      ...
      >
        <div className="container mx-auto px-4 pt-10 pb-8 sm:pt-12 sm:pb-10 md:pt-16 md:pb-16">
          ...
          >
            ...
            <div className="w-full flex justify-center mb-3 sm:mb-4 -my-4 sm:-my-6">
              <img
                src={nexusHero}
                ...
                fetchPriority="high"
                decoding="async"
                className="w-auto max-h-[320px] sm:max-h-[380px] md:max-h-[440px] object-contain"
              />
            </div>
