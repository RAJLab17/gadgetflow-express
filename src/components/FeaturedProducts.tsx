...
const product = {
  ...
  price: 99.00,
  originalPrice: 129,
  images: [charger3in1Specs, charger3in1ColorsNew, charger3in1Action1, charger3in1Action2, charger3in1Angles, charger3in1LifestyleHome, charger3in1LifestyleOffice],
  rating: 5,
  reviews: 89,
