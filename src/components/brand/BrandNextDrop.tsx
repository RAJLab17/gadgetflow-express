...
import matrixImgAsset from "@/assets/home/matrix-cherry-raj-home.png.asset.json";
import airpodsRender from "@/assets/matrix/airpods-cherry-bolt.webp";
import airpodsPhoto from "@/assets/matrix/airpods-cherry.png";
...
const BrandNextDrop = () => {
  ...
  return (
    <section
      className="relative pt-10 md:pt-12 pb-12 md:pb-16 mt-0 z-20 overflow-hidden"
    ...
    >
      <div className="container mx-auto px-6 sm:px-10 max-w-[1240px] relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 lg:gap-x-8 gap-y-10 md:gap-y-20">
          {/* NEXUS — Hauptobjekt */}
          ...
          <Link to="/matrix" className="group block">
            <div className="relative mb-6 overflow-hidden rounded-sm">
              ...
              {/* AirPods 4 & 5 Case — Inset neben dem iPhone-Case */}
              <div className="absolute bottom-4 right-4 flex flex-col items-center gap-1.5">
                ...
                >
                  <img
                    src={airpodsRender}
                    alt="RAJ MATRIX AirPods 4 & 5 Case in Cherry Carbon"
                    width={96}
                    height={96}
                    loading="lazy"
                    decoding="async"
            ...
            >
              <span
                ...
                style={{ borderColor: `${GOLD_SOFT}55`, background: "rgba(10,9,8,0.4)" }}
              >
                <img
                  src={airpodsRender}
                  alt=""
