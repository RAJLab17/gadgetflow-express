...
const sections: Section[] = [
  {
    ...
    content: [
      `Der Schutz deiner personenbezogenen Daten ist der RAJ AG (nachfolgend „RAJ", „wir" oder „uns") ein wichtiges Anliegen. Diese Datenschutzerklärung informiert darüber, wie wir personenbezogene Daten im Zusammenhang mit dem Besuch unserer Website und der Nutzung unseres Online‑Shops bearbeiten.`,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Datenschutzerklärung der RAJ AG. Informationen zur Erhebung und Bearbeitung personenbezogener Daten." />
      </Helmet>
      <Header />
