      ...
      <div className="space-y-12 md:space-y-14">
        ...
        <Section title="Haftungsausschluss">
          <p>
            ...
            Aktualität der Inhalte übernimmt RAJ jedoch keine Gewähr.
          </p>
          <p>
            Haftungsansprüche gegen RAJ wegen Schäden materieller oder immaterieller Art, welche aus dem Zugriff oder
        ...
        <Section title="Urheberrechte">
          <p>
            ...
            gehören ausschliesslich RAJ oder den speziell genannten Rechteinhabern.
          </p>
          <p>
