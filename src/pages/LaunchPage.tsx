        ...
        <div className="relative z-10">
          ...
          <section className="container mx-auto px-4 pt-8 pb-16 md:pt-16 md:pb-24">
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                Die ersten 100 Stück gehen bald raus.
                <br />
                Trag dich ein und sichere dir deinen Platz.
              </motion.p>
          ...
          <footer className="border-t border-border py-8">
            <div className="container mx-auto px-4 flex flex-col items-center gap-4 text-center">
              ...
              <div className="flex items-center gap-5">
                ...
                <a href="https://www.facebook.com/rajswiss.ch/" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="Facebook">="https://www.facebook.com/rajswiss.ch/" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="Facebook"> target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="Facebook">
