    ...
    <>
      ...
      >
        ...
        <div className="md:hidden relative px-5 pt-1 pb-0" style={{ zIndex: 2 }}>
          ...
          <div style={{ position: "relative", width: "100%", maxWidth: "min(48vh, 400px)", margin: "0 auto 8px", aspectRatio: "1/1", maxHeight: "min(48vh, 400px)", borderRadius: 0, overflow: "hidden", boxShadow: "0 30px 80px -30px rgba(0,0,0,.16)" }}>
