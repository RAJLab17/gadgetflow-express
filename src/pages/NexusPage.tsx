    ...
    <>
      ...
      >
        ...
        <div className="md:hidden relative px-5 pt-1 pb-0" style={{ zIndex: 2 }}>
          ...
          <div style={{ position: "relative", width: "calc(100% + 40px)", maxWidth: "none", margin: "0 -20px 8px", aspectRatio: "1/1", maxHeight: "min(46dvh, 46svh, 420px)", borderRadius: 0, overflow: "hidden", boxShadow: "0 30px 80px -30px rgba(0,0,0,.16)" }}>
