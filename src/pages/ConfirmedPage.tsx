    ...
    <>
      ...
      <div className="min-h-screen bg-background flex items-center justify-center px-4 relative overflow-hidden">
        ...
        >
          ...
          >
            <Link to="/">
              <img src={logo} alt="RAJ" className="h-14 w-auto mx-auto mb-12 hover:opacity-80 transition-opacity" />
            </Link>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-muted-foreground text-lg leading-relaxed mb-4 max-w-sm mx-auto"
          >
          ...
          <motion.p
            ...
            className="text-muted-foreground/70 text-sm mb-10 max-w-xs mx-auto"
          >
            RAJ entwickelt hochwertige Ladeprodukte mit Fokus auf Präzision, Design und Alltagstauglichkeit.
          </motion.p>
          ...
          <motion.p
            ...
            className="mt-16 text-xs text-muted-foreground/50 tracking-widest uppercase"
          >
            Power. Always There.
          </motion.p>
        </motion.div>
